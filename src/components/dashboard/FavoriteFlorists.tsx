    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {favorites?.map((favorite) => (
        <FloristCard
          ...
          streetAddress={favorite.florist_profiles.street_address}
          suburb={favorite.florist_profiles.suburb}
          state={favorite.florist_profiles.state}
          postcode={favorite.florist_profiles.postcode}
