...
export const Hero = () => {
  return (
    <section className="relative min-h-[650px] md:h-[50vh] md:min-h-[600px] flex items-center justify-center bg-[#FFFFFF] py-8 mt-16 md:mt-0">
      ...
      <div className="container relative z-10 px-4 md:px-8 flex flex-col items-center">
        <div className="max-w-3xl mx-auto text-center mb-6 md:mb-8">
          ...
          <p className="text-base md:text-xl text-white/90 font-light max-w-xl mx-auto leading-relaxed mb-6 md:mb-8">
