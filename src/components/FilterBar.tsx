    ...
    <div className="bg-white/20 backdrop-blur-md rounded-xl p-6 border border-white/20">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="space-y-2">
          ...
          <div className="relative h-10">
            ...
            <Input 
              ...
              className="w-full h-full pl-10 bg-white/80 backdrop-blur-sm border-white/20"
            />
          </div>
        </div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                variant="outline"
                className={cn(
                  "w-full h-10 justify-start text-left font-normal bg-white/80 backdrop-blur-sm border-white/20",
        ...
        <div className="space-y-2">
          ...
          <div className="px-3 h-10 rounded-md border border-white/20 bg-white/80 backdrop-blur-sm flex items-center">
            <Slider
              value={budget}
        ...
        <div className="space-y-2">
          ...
          <Select>
            <SelectTrigger className="h-10 bg-white/80 backdrop-blur-sm border-white/20">
