...
export const GlareCard = ({
  ...
  const containerStyle = {
    ...
    "--foil-size": "100%",
    "--opacity": "0",
    "--radius": radius === "lg" ? "0.5rem" : "0.25rem",
    "--easing": "ease",
  ...
  const backgroundStyle = {
    ...
    "--shade":
      "radial-gradient( farthest-corner circle at var(--m-x) var(--m-y),rgba(255,255,255,0.05) 12%,rgba(255,255,255,0.075) 20%,rgba(255,255,255,0.125) 120% ) var(--bg-x) var(--bg-y)/300% no-repeat",
  ...
  return (
    <div
      ...
      ref={refElement}
      onPointerMove={(event) => {
        const rotateFactor = 0.2; // Reduced from 0.4 for subtler effect
