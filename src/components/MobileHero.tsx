...
export const MobileHero = () => {
  return (
    <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center bg-[#FFFFFF] md:hidden">
      ...
      <div className="container relative z-10 px-4 flex flex-col items-center mt-40">
